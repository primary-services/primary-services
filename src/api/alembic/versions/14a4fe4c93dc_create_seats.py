...
Revision ID: 14a4fe4c93dc
Revises: 3120ca102a3c
Create Date: 2025-04-24 10:20:32.474466
...
def upgrade() -> None:
    ...
    op.drop_constraint('election_office_id_fkey', 'election', type_='foreignkey')
    ...
    op.add_column('term', sa.Column('seat_id', sa.Integer(), nullable=False))
    op.drop_constraint('term_office_id_fkey', 'term', type_='foreignkey')
    op.create_foreign_key(None, 'term', 'seat', ['seat_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.add_column('election', sa.Column('office_id', sa.INTEGER(), autoincrement=False, nullable=True))
    ...
    op.add_column('election', sa.Column('seat_count', sa.INTEGER(), autoincrement=False, nullable=False))
    op.create_foreign_key('election_municipality_id_fkey', 'election', 'municipality', ['municipality_id'], ['id'])
    op.create_foreign_key('election_office_id_fkey', 'election', 'office', ['office_id'], ['id'])
